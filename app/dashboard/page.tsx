...
const stats = [
    { label: 'Total Applied', val: '142', sub: '+12% month over month', icon: Briefcase, color: "text-blue-600", bg: "bg-blue-50" },
    { label: 'Interviews', val: '12', sub: '3 scheduled this week', icon: Clock, color: "text-amber-500", bg: "bg-amber-50" },
    { label: 'Offer Rate', val: '2.4%', sub: 'Higher than average (1.8%)', icon: TrendingUp, color: "text-emerald-500", bg: "bg-emerald-50" },
    { label: 'Active Pipeline', val: '18', sub: 'Currently in discussion', icon: Zap, color: "text-indigo-600", bg: "bg-indigo-50" },
];
        ...
        <div className="space-y-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="mt-2 text-sm font-medium text-zinc-400">Welcome back, John. You have 3 interviews coming up this week.</p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-zinc-300 translate-y-px">Syncing 24 Active threads</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {stats.map((stat, i) => (
                    <motion.div
                        ...
                        className="group rounded-[2rem] border border-zinc-100 bg-white p-8 transition-all hover:border-blue-100 hover:shadow-[0_20px_40px_rgba(28,78,216,0.03)]"
                    >
                        ...
                        <div className="mt-6">
                            ...
                            <div className="mt-1 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-300">{stat.label}</div>
                            <div className="mt-4 text-[10px] font-bold text-zinc-400">{stat.sub}</div>
                        </div>
                    </motion.div>
                ))}
            </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="rounded-[2rem] border border-zinc-100 bg-white overflow-hidden shadow-sm">
                            ...
                            {recentApplications.map((app) => (
                                <div key={app.company} className="group flex items-center justify-between p-6 transition-all hover:bg-zinc-50/50">
                                    <div className="flex items-center gap-5">
                                        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-zinc-50 text-[11px] font-black text-zinc-800 border border-zinc-100 group-hover:bg-white group-hover:text-[#1C4ED8] transition-all">
                                            {app.company[0]}
                                        </div>
                                        <div>
                        ...
                        <div className="bg-zinc-50/50 p-4 text-center border-t border-zinc-50">
                            <button className="text-[10px] font-black uppercase tracking-widest text-zinc-400 hover:text-black">Show All Applications</button>
                        </div>
                    </div>

                    {/* AI Strategic Insight - Dashboard Version */}
                    <div className="p-8 rounded-[2.5rem] bg-[#1C4ED8] text-white shadow-[0_30px_60px_rgba(28,78,216,0.15)] relative overflow-hidden group">
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="space-y-4">
                            {upcomingInterviews.map((interview) => (
                                <div key={interview.company} className="rounded-3xl border border-zinc-100 bg-white p-6 shadow-sm group hover:border-[#1C4ED8] transition-all">
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                <button key={item.label} className="flex flex-col items-center justify-center gap-3 rounded-[2rem] border border-zinc-100 bg-white p-6 transition-all hover:bg-zinc-50 hover:border-zinc-200 group">
